export const strings = {
  ...
  aboutMeInfo: `One thing you could hear me talking non-stop about are all my <b>favorite TV shows</b>: Brooklyn Nine-Nine, Avatar: The Last Airbender, 
  ...
  binging a brand new series or rewatching a classic. <br><br> While I watch my shows, I’m usually (sometimes even simultaneously :>) <b>designing or coding, or both</b>! These are the three things that I find I can do almost endlessly: 
  trying to puzzle through an episode’s cliffhanger, a design challenge, or yet another bug in my code. <br><br> In my spare time, I also love singing with my ukulele, scuba diving, badminton,
  teaching computer science as a <b><i><a href="https://ubccsss.org/services/courses/cpsc-213/" target="_blank" rel="noopener noreferrer">CPSC 213</a></i> TA at UBC</b>,  wakeboarding, cooking & eating Filipino food (ily Jollibee!), advocating for <b>gender equality in tech</b>, and learning about <b>UX/UI or blockchain</b>.`,
  viewResume: "View My Resume",
  secretFooter:
    "This website was designed & coded from scratch by Misha Reyes using TypeScript, React, Next.js, and Tailwind CSS :D",
};
...
// class projects that could be placed in here
// unity project of thtr 399e
// figma project of cpsc 344
// database project of cpsc 304
// mern stack project of cpsc 455

export const brewLab_strings = {
  title: "Brew Lab",
  par: [
    `I worked as a <b>Design Intern for Brew Lab</b> from 2020 to 2021. I managed social media marketing post scheduling and creation, 
  ...
  in order to create a feed that does not overwhelm with text, but engages the user with varied content.`,
    `And that concludes my work with Brew Lab! It was a truly enjoyable experience working with the tight-knit team; their constant support and 
  ...
  featured_project: [
    {
      src: "/brewlab/info1.jpg",
      alt: "How to Brew Beer Step 1",
    },
    {
      src: "/brewlab/info2.jpg",
      alt: "How to Brew Beer Step 2",
    },
    {
      src: "/brewlab/info3.jpg",
      alt: "How to Brew Beer Step 3",
    },
    {
      src: "/brewlab/info4.jpg",
      alt: "How to Brew Beer Step 4",
    },
    {
      src: "/brewlab/info5.jpg",
      alt: "How to Brew Beer Step 5",
    },
    {
      src: "/brewlab/info6.jpg",
      alt: "Price of Bundle Kit",
    },
  ],
  gallery: [
    [
